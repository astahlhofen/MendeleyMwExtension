...
class Configuration {
	...
	public static $wgMendeleyConsumerKey = null;
	public static $wgMendeleyConsumerSecret = null;
	...
	public static function getConsumer() {
		$consumer['default'] = array(
			'key' => Configuration::$wgMendeleyConsumerKey,
			'secret' => Configuration::$wgMendeleyConsumerSecret
		);
